...
export const mockProblems: Problem[] = [
  {
    ...
    description: "Every day, college cafeterias across the country throw away massive amounts of perfectly good food while many students face food insecurity.",
  ...
  },
  {
    ...
    description: "College counseling centers are overwhelmed, with average wait times of 2-3 weeks for appointments.",
    image: "/api/placeholder/400/240",
  ...
  },
  {
    ...
    description: "The average student spends $1,240 annually on textbooks, creating financial barriers to education.",
    image: "/api/placeholder/400/240",
    author: "Alex Rivera",
    date: "2024-01-10",
    upvotes: 89,
